...
docker buildx build --platform linux/amd64  -t $DOCKERHUB_UNAME/RecipeApp:$NEW_VERSION -f assessement_5/Dockerfile ./assessement_5 --no-cache
docker push $DOCKERHUB_UNAME/RecipeApp:$NEW_VERSION